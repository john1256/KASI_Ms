...
fig3 = corner.corner(result_BAO_flat.samples, weights=result_BAO_flat.weights, labels=[r'$\Omega_m$', r'$H_0$'],
                    quantiles=[0.16, 0.5, 0.84], range = [0.99999, 0.99999], bins=30, show_titles=True)
_ = fig3.suptitle('BAO flat LCDM cosmology nested sampling result', fontsize=16)
fig3.tight_layout()
...
_ = fig4.suptitle('BAO curved LCDM cosmology nested sampling result', fontsize=16)
fig4.tight_layout()
