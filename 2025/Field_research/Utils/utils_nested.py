...
def prior_BAO_curved(x):
    # Omegam in [0,6.437185929648241], Omegalamb in [-3,1], H0 in [17.88459283, 23.17205389]
    prior = x * np.array([6.437185929648241, 4, 23.17205389 - 17.88459283]) + np.array([0, -3, 17.88459283])
    return prior
